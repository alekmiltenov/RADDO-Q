...
# Canonical motifs in the exact format used by Dynamic_Decoupling.
# They are NOT expanded because the simulator already repeats them with
# dd_sequence[i % len(dd_sequence)].
